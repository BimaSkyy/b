...
client.on('ready', async () => {
   ...
   require('./server')(PORT), require('./lib/system/config'), require('./lib/system/baileys')(client.sock), require('./lib/system/functions'), require('./lib/system/scraper')
...
client.on('group.add', async ctx => {
   const sock = client.sock
   const text = `Halo +tag Welcome To +grup silakan mau intro atau tidak, karna tidak ada paksaan`
