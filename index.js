...
const { spawn: spawn } = require('child_process'), { Function: Func } = new(require('@neoxr/wb')), path = require('path'), colors = require('@colors/colors/safe'), CFonts = require('cfonts'), chalk = require('chalk'), cluster = require('cluster'), Readline = require('readline'), yargs = require('yargs/yargs')
