      ...
      try {
         ...
         if (!mime) {
            ...
            const mailOptions = {
               ...
               to: to.trim(),
               subject: subject.trim(),
               html: `<div style="padding:20px;border:1px dashed #222;font-size:15px"><tt>Hi <b>${m.pushName} 😘</b><br><br>${msg.trim()}<br><br><hr style="border:0px; border-top:1px dashed #222"><br>Regards, <b>Xinzuo Support</b></tt></div>`,
               attachments: [{
